...
const StageoFooterSection = () => {
  return (
    <footer className="relative w-full text-white overflow-hidden">
      ...
      {/* 2. CONTENT CONTAINER */}
      <div className="relative z-10 pt-24 pb-12 px-6 md:px-20">
        ...
        <div className="flex flex-col items-center text-center mb-24">
          ...
          <p className="max-w-xl text-gray-300 text-sm md:text-base mb-10 leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 mb-20">
          ...
          {/* Column 2: Events */}
          <div>
            <h4 className="text-[10px] tracking-[0.2em] uppercase font-bold text-gray-400 mb-6">Events</h4>
          ...
          {/* Column 3: Company */}
          <div>
            <h4 className="text-[10px] tracking-[0.2em] uppercase font-bold text-gray-400 mb-6">Company</h4>
            <ul className="space-y-3 text-sm text-gray-300">
          ...
          {/* Column 4: Support */}
          <div>
            <h4 className="text-[10px] tracking-[0.2em] uppercase font-bold text-gray-400 mb-6">Support</h4>
            <ul className="space-y-3 text-sm text-gray-300">
