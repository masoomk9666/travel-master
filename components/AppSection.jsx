...
const AppSection = () => {
  ...
  return (
    <section className="relative bg-[#0D0D0D] text-white pb-10 pt-10 md:pb-20 lg:pt-35 px-4 sm:px-6 md:px-8 lg:px-16 overflow-hidden">
      <div className="absolute top-0 -right-20 w-[400px] h-[400px] bg-[#006DF269] blur-[120px] rounded-full hidden lg:block"></div>

      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-12 items-center">
        {/* Left Content */}
        <div className="space-y-8 order-2 lg:order-1">
          <div className="space-y-4">
            <h2 className="text-3xl sm:text-4xl md:text-[45px] font-bold leading-tight">
              Your Event Travel <br /> in Your Pocket
            </h2>
          ...
          <ul className="space-y-4">
            {features.map((item, index) => (
              <li
                ...
                className="flex items-center gap-3 group border-b border-white/10 group-last:border-none pb-5"
              >
                <div className="p-1 bg-[#006DF2] rounded-full flex-shrink-0">
                  <Check className="text-white w-4 h-4 fill-blue-500/10" />
                </div>
                <span className="text-gray-300 text-[14px] sm:text-[15px] md:text-[16px] w-full">
                  {item}
                </span>
              </li>
            ))}
          ...
          <div className="flex flex-wrap gap-4 pt-4 justify-center md:justify-start">
            <a href="#" className="hover:opacity-80 transition">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/3/3c/Download_on_the_App_Store_Badge.svg"
                alt="App Store"
                className="h-10 md:h-12 border border-[#3D3D3D] rounded-lg"
              />
            </a>
            <a href="#" className="hover:opacity-80 transition">
              <img
        ...
        {/* Right Content - Phone Mockups */}
        <div className="relative flex justify-center lg:justify-end items-center h-[300px]  md:h-[400px] lg:h-[600px] order-1 lg:order-2">
          {/* Blue Radial Glow Background */}
          <div className="absolute top-1/2 right-0 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-[#A871F454] blur-[120px] rounded-full hidden lg:block"></div>
