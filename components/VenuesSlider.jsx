...
export default function VenuesSlider() {
  ...
  return (
    <section className="bg-black py-10 md:py-16 overflow-hidden border-t border-white/5">
      {/* --- HEADING --- */}
      <div className="max-w-7xl mx-auto px-6 md:px-10 mb-8 text-left">
        <h2 className="text-lg md:text-3xl font-bold text-white/90 tracking-tight">
          Venues We Travel To
        </h2>
      </div>
      ...
      <div className="relative flex">
        <motion.div 
          className="flex gap-4 md:gap-5 px-6 md:px-10" 
          animate={{ x: ["0%", "-33.33%"] }}
          transition={{
            duration: 30,
            repeat: Infinity,
