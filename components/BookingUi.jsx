...
const BookingUi = () => {
  ...
  const provinceImages = {
    Ulster: {
      ...
      className: "w-[50%] h-[50%] -top-[6%] left-[32%]",
    },
    Connacht: {
    ...
    Leinster: {
      ...
      className: "w-[45%] h-[45%] top-[25%] right-[15%]",
    },
    Munster: {
      src: "/booking-ui/province03.png", // Replace with your image path
      className: "w-[55%] h-[55%] bottom-[6%] left-[10%]",
    },
  };
  const features = [
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-6 space-y-8">
          ...
          <div className="grid grid-cols-4 bg-[#111] rounded-2xl overflow-hidden border border-white/10 shadow-xl">
            ...
            <div className="flex flex-col items-center py-3 border-r border-white/5">
              ...
              <span className="font-medium text-[18px]">{seats} Seat</span>
            </div>
        ...
        <div className="lg:col-span-6">
          <div className="bg-[radial-gradient(circle_at_bottom_right,#006df2a1,transparent_50%)] bg-[#0D0D0D] via-[#0D0D0D] to-[#006df2a1]  rounded-3xl p-8 shadow-[0_0_50px_rgba(0,0,0,1)] relative overflow-hidden">
            ...
            {currentStep === 1 && (
              <div className="animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                {/* <div className="flex justify-center mb-6">
                  <svg
                    viewBox="0 0 200 220"
                    className="w-56 h-64 drop-shadow-[0_0_15px_rgba(59,130,246,0.2)]"
                  >
                    <path
                      d="M100 10 L140 25 L155 60 L130 85 L90 80 L70 50 Z"
                      fill={selectedProvince === "Ulster" ? "#3b82f6" : "#333"}
                      onClick={() => setSelectedProvince("Ulster")}
                      className="cursor-pointer transition-colors duration-300"
                    />
                    <path
                      d="M70 50 L90 80 L105 130 L60 150 L30 130 L20 80 Z"
                      fill={
                        selectedProvince === "Connacht" ? "#3b82f6" : "#444"
                      }
                      onClick={() => setSelectedProvince("Connacht")}
                      className="cursor-pointer transition-colors duration-300"
                    />
                    <path
                      d="M130 85 L170 100 L180 160 L140 180 L105 130 L90 80 Z"
                      fill={
                        selectedProvince === "Leinster" ? "#3b82f6" : "#555"
                      }
                      onClick={() => setSelectedProvince("Leinster")}
                      className="cursor-pointer transition-colors duration-300"
                    />
                    <path
                      d="M60 150 L105 130 L140 180 L120 210 L50 210 L30 180 Z"
                      fill={selectedProvince === "Munster" ? "#3b82f6" : "#222"}
                      onClick={() => setSelectedProvince("Munster")}
                      className="cursor-pointer transition-colors duration-300"
                    />
                  </svg>
                </div> */}
                {/* IRELAND MAP CONTAINER */}
                <div className="relative w-full aspect-[4/5] max-w-[320px] mx-auto mb-10">
                    ...
                    <img
                      ...
                      className={`absolute cursor-pointer transition-all duration-300  object-contain
                        ${selectedProvince === name 
                          ? " brightness-125 z-10" 
                          : "opacity-60 grayscale hover:grayscale-0 hover:opacity-100 z-0"
                        } ${data.className}`}
                    />
                  ))}
                </div>
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-[18px] text-[#D0D0D0]">{p.address}</p>
                        </div>
                      </div>
            ...
            {currentStep === 3 && (
              <div className="animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                <div className="bg-[#151515] p-8 rounded-2xl flex items-center justify-between mb-10">
                  <span className="text-[22px] text-gray-300">Number of seats</span>
            ...
            {/* <button
              onClick={handleNext}
              className="w-full bg-[#006DF2] hover:bg-[#0060d0] text-[18px] text-white font-bold py-4 rounded-2xl mt-8 flex items-center justify-between gap-3 transition-all active:scale-95 shadow-[0_10px_20px_rgba(0,112,243,0.3)] cursor-pointer"
            >
...
//     Ulster: {
//       src: "/booking-ui/province01.png", // Replace with your image path
//       className: "w-[45%] h-[35%] top-[10%] left-[25%]",
//     },
//     Connacht: {
//       src: "/booking-ui/province02.png", // Replace with your image path
//       className: "w-[40%] h-[40%] top-[28%] left-[8%]",
//     },
//     Leinster: {
//       src: "/booking-ui/province04.png", // Replace with your image path
//       className: "w-[38%] h-[50%] top-[25%] right-[18%]",
//     },
//     Munster: {
//       src: "/booking-ui/province03.png", // Replace with your image path
//       className: "w-[48%] h-[40%] bottom-[8%] left-[15%]",
//     },
//   };
...
//   const pickupPoints = [
//     { id: 1, name: "Dublin City Center", address: "O Connell Street", time: "7 : 00 pm" },
//     { id: 2, name: "Dun Laoghaire", address: "Harbour Road", time: "7 : 00 pm" },
//     { id: 3, name: "Greystones", address: "Main Street", time: "7 : 00 pm" },
//   ];
...
//   return (
//     <div className="min-h-screen bg-black text-white p-6 !pt-50 md:p-16 font-sans selection:bg-blue-500">
//       <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
//         {/* LEFT SIDE - EVENT INFO */}
//         <div className="lg:col-span-6 space-y-8">
//           <div>
//             <h1 className="text-[62px] font-bold tracking-tighter">Calvin Harris</h1>
//             <p className="text-white text-[17px]">Malahide Castle, Dublin • {selectedDate.date}</p>
//           </div>

//           <ul className="grid grid-cols-1 md:grid-cols-1 gap-4">
//             {features.map((item, i) => (
//               <li key={i} className="flex items-center gap-3 text-[#9996A0] text-[17px]">
//                 <div className="p-1 bg-blue-500 rounded-full">
...
//           <div className="grid grid-cols-4 bg-[#111] rounded-2xl overflow-hidden border border-white/10 shadow-xl">
//             <div className="flex flex-col items-center py-3 border-r border-white/5">
//               <span className="text-[14px] uppercase tracking-widest text-[#D0D0D0] font-[500] mb-1">County</span>
//               <span className="font-medium text-[18px]">{selectedCounty || "-"}</span>
//             </div>
//             <div className="flex flex-col items-center py-3 border-r border-white/5">
//               <span className="text-[14px] uppercase tracking-widest text-[#D0D0D0] font-[500] mb-1">Pickup</span>
//               <span className="font-medium text-[18px]">{selectedPickup?.name || "-"}</span>
//             </div>
//             <div className="flex flex-col items-center py-3 border-r border-white/5">
//               <span className="text-[14px] uppercase tracking-widest text-[#D0D0D0] font-[500] mb-1">Seats</span>
//               <span className="font-medium text-[18px]">{seats} Seat</span>
//             </div>
//             <div className="flex flex-col items-center py-3 bg-white text-black">
//               <span className="text-[14px] uppercase tracking-widest font-[500] mb-1">Pay</span>
//               <span className="font-medium text-[18px]">${totalAmount}</span>
//             </div>
//           </div>

//           <div className="space-y-4">
//             <h3 className="text-xl font-bold border-b border-white/10 pb-2">Description:</h3>
//             <p className="text-[#9996A0] leading-[38px] text-[18px]">
//               Bus to Calvin Harris Malahide Castle Dublin 2026 – Nationwide Return...
//             </p>
//           </div>
//         </div>
...
//         {/* RIGHT SIDE - FORM */}
//         <div className="lg:col-span-6">
//           <div className="bg-[radial-gradient(circle_at_bottom_right,#006df2a1,transparent_50%)] bg-[#0D0D0D] rounded-3xl p-8 shadow-[0_0_50px_rgba(0,0,0,1)] relative overflow-hidden">
//             {/* INTERACTIVE TABS */}
//             <div className="grid grid-cols-4 gap-2 mb-10 bg-white/5 rounded-xl">
//               {STEPS.map((step, idx) => (
//                 <button
...
//                     <div
//                       key={i}
//                       onClick={() => setSelectedDate({ id: i, date: `${10 + i * 4}th March 2026`, time: "7:00 pm" })}
//                       className={`p-4 rounded-2xl border cursor-pointer transition-all flex items-center justify-between ${selectedDate.id === i ? "bg-[#1D1D1D] border-blue-500" : "bg-[#1D1D1D] border-transparent"}`}
//                     >
//                       <div className="flex items-start gap-4">
//                         <Calendar className="w-7 h-7 text-white mt-1" />
//                         <div className="space-y-2">
//                           <p className="text-[18px]">2{i}th March 2026</p>
//                           <p className="text-[16px] text-[#FFFFFF99]">8:00 pm</p>
//                         </div>
//                       </div>
//                       <div className={`w-5 h-5 rounded-full border-2 ${selectedDate.id === i ? "bg-blue-500 border-blue-500" : "border-gray-600"}`} />
//                     </div>
//                   ))}
//                 </div>
//               </div>
...
//             {/* STEP 1: COUNTY (IMAGE BASED MAP) */}
//             {currentStep === 1 && (
//               <div className="animate-in fade-in slide-in-from-right-4 duration-300">
//                 <h2 className="text-[24px] mb-1">Where are you travelling from?</h2>
//                 <p className="text-gray-500 text-[18px] mb-6">Tap your province on the map.</p>
...
//                       className={`absolute cursor-pointer transition-all duration-300 object-contain
//                         ${selectedProvince === name 
//                           ? "drop-shadow-[0_0_20px_rgba(59,130,246,0.8)] brightness-125 scale-105 z-10" 
//                           : "opacity-60 grayscale hover:grayscale-0 hover:opacity-100 z-0"
//                         } ${data.className}`}
//                     />
//                   ))}
...
//                 <h3 className="text-[24px] mb-4">{selectedProvince} Counties</h3>
//                 <div className="flex flex-wrap gap-2">
//                   {provinces[selectedProvince].map((c) => (
//                     <button
//                       key={c}
...
//             {currentStep === 2 && (
//               <div className="animate-in fade-in slide-in-from-right-4 duration-300">
//                 <h2 className="text-[24px] mb-6 text-center md:text-left">Choose your pickup point</h2>
//                 <div className="space-y-4">
//                   {pickupPoints.map((p) => (
//                     <div
//                       key={p.id}
...
//                     >
//                       <div className="flex items-start gap-4">
//                         <div className={`w-7 h-7 rounded-full border-2 flex items-center justify-center mt-1 ${selectedPickup?.id === p.id ? "border-blue-500" : "border-gray-700"}`}>
//                           {selectedPickup?.id === p.id && <div className="w-3 h-3 bg-blue-500 rounded-full" />}
//                         </div>
//                         <div>
//                           <p className="text-[18px] text-gray-100">{p.name}</p>
//                           <p className="text-[18px] text-[#D0D0D0]">{p.address}</p>
//                         </div>
//                       </div>
//                       <span className="text-[16px] text-gray-400">{p.time}</span>
//                     </div>
//                   ))}
//                 </div>
//               </div>
...
//                   <span className="text-[22px] text-gray-300">Number of seats</span>
//                   <div className="flex items-center gap-6">
//                     <button onClick={() => setSeats(Math.max(1, seats - 1))} className="w-10 h-10 rounded-full border border-gray-700 flex items-center justify-center hover:bg-white/5 cursor-pointer">
//                       <Minus className="w-4 h-4" />
//                     </button>
//                     <span className="text-[24px] font-bold">{seats.toString().padStart(2, "0")}</span>
//                     <button onClick={() => setSeats(seats + 1)} className="w-10 h-10 rounded-full border border-gray-700 flex items-center justify-center hover:bg-white/5 cursor-pointer">
//                       <Plus className="w-4 h-4" />
//                     </button>
//                   </div>
//                 </div>
...
//       {/* FOOTER CONTENT */}
//       <div className="max-w-7xl mx-auto grid grid-cols-1 gap-12 mt-12">
//         <ul className="text-[#9996A0] leading-[38px] text-[18px]">
//           <li>Choose from various counties across Ireland for the Calvin Harris concert bus.</li>
//           <li>This is a RETURN bus service (Price includes BOTH WAYS).</li>
//         </ul>
//       </div>

//       {/* BOTTOM GLOW */}
//       <div className="fixed bottom-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-blue-600 to-transparent blur-[1px]" />
//     </div>
//   );
// };
