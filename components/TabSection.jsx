...
export default function EventTabs() {
  ...
  return (
    <section className="bg-black text-white py-8 sm:py-12 px-4 sm:px-6  font-sans" id='concerts'>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative mb-8 sm:mb-12">
          ...
          <div 
            ...
            className="flex overflow-x-auto scrollbar-hide gap-[2px] snap-x snap-mandatory"
            ...
            {TABS.map((tab) => {
              ...
              return (
                <button
                  key={tab.name}
                  onClick={() => handleTabClick(tab)}
                  className={`flex-shrink-0 min-w-[140px] sm:min-w-[180px] md:min-w-[200px] py-3 px-4 text-[14px] sm:text-[16px] md:text-[18px] text-[#FFFFFF] transition-all flex items-center justify-center gap-2 sm:gap-5 cursor-pointer snap-start ${
                    activeTab === tab.name && !tab.isLink
                      ? 'bg-[#333333] text-white' 
                      : 'bg-[#0D0D0D] hover:bg-[#181818]'
                  }`}
                >
                  <Icon size={20} strokeWidth={2.5} className="sm:w-[22px] sm:h-[22px] md:w-[25px] md:h-[25px]" />
              ...
              >
                ...
                <div className="relative h-[90px] sm:h-[100px] p-3 sm:p-4 flex flex-col justify-center overflow-hidden transition-colors duration-300 group-hover:bg-[#1a1a1a] rounded-b-[10px]">
                  <div className="transition-all duration-300 transform group-hover:-translate-y-8 sm:group-hover:-translate-y-10 group-hover:opacity-0">
                    ...
                    <p className="text-[10px] sm:text-[12px] text-zinc-300 truncate">{show.venue}</p>
                    <p className="text-[8px] sm:text-[10px] text-zinc-300">{show.date}</p>
                  </div>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 translate-y-8 sm:translate-y-10 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 px-3 sm:px-4">
                    <Link href="/booking" className="w-full">
                      <button className="w-full bg-[#006DF2] text-white py-2.5 sm:py-3 px-3 sm:px-5 text-[10px] sm:text-[11px] font-medium rounded-[6px] tracking-widest hover:bg-white hover:text-black transition-colors flex items-center justify-center gap-2 cursor-pointer">
                        BOOK NOW
                      </button>
                    </Link>
                  </div>
